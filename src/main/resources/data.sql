...
INSERT INTO image (id, width, height, image_type, size) VALUES (1, 300, 200, 'JPG', 1024), (2, 300, 200, 'JPG', 1024);

INSERT INTO session (id, amount, number_of_maximum_members, session_type, session_status, session_recruitment_status, start_at, end_at) VALUES (1, 1000, 999, 'FREE', 'PREPARING', 'PROCESSING', CURRENT_TIMESTAMP(), '9999-12-31 23:59:59');

INSERT INTO session_member (ns_user_id, session_id) VALUES (1, 1), (2, 1);

INSERT INTO session_image (session_id, image_id) VALUES (1, 1), (1, 2);
