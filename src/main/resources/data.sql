...
INSERT INTO image (id, width, height, image_type, size) VALUES (1, 300, 200, 'JPG', 1024);

INSERT INTO session (id, amount, number_of_maximum_members, session_type, session_status, session_recruitment_status, image_id, start_at, end_at) VALUES (1, 1000, 999, 'FREE', 'PREPARING', 'PROCESSING', 1, CURRENT_TIMESTAMP(), '9999-12-31 23:59:59');
